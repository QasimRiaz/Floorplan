...
html+='<p id="messageerror"></p><script>jQuery("#depositsstatus").click(function(){if(jQuery("#depositsstatus option:selected").val() !="no"){jQuery(".depositsdetail").show(); }else{ jQuery(".depositsdetail").hide();} });</script> <div class="row" style="margin-bottom: 2%;margin-top: 3%;"><div class="col-sm-2" style="text-align:right;"><label>Selected Booths</label></div><div class="col-sm-8">'+selectedBoothtitles+'</div></div><div class="row" style="margin-bottom: 1%;"><div class="col-sm-2" style="text-align:right;"><label>Price</label></div><div class="col-sm-3"><div class="input-group"><span style="height:20px;"class="input-group-addon"><strong style="color:#333">'+currencysymbole+'</strong></span><input type="number" style="color:#333;height:32px;width: 99%;" id="boothprice" value="'+boothprice+'" class="form-control currency"></div></div></div>'+htmlfordeposite+'<div class="row" style="margin-bottom: 3%;"><div class="col-sm-2" style="text-align:right;"><label >Product Description <i class="far fa-question-circle"  title="This content will appear in the pop-up when users click this booth. Note this will no longer show after a booth is purchased."></i></label></div><div class="col-sm-8"><textarea id="boothdescripition" class="form-control" rows="8">'+unescape(boothdescripition)+'</textarea></div></div><div class="row" style="margin-bottom: 1%; margin-left: 133px; color: gray"><h5 class="eg-sub-title"><strong>IF this booth is purchased, THEN</strong></h5></div><div class="row" style="margin-bottom: 3%;"><div class="col-sm-2" style="text-align:right;"><label>Assign/Re-Assign User Level <i class="far fa-question-circle" title="Select the Level the user will be automatically assigned to upon purchasing this booth. "></i></label></div><div class="col-sm-3"><select id="boothlevelvalue" class="form-control">'+boothlevelname+'</select></div></div><div class="row" style="margin-bottom: 3%;"><div class="col-sm-1" ></div><div class="col-sm-1" id="updateproductbutton"></div><div class="col-sm-2"></div></div>';      
...
StyleFormatPanel.prototype.addExhibitors = function(container)
{
	...
	var btypename = document.createElement('div');
        btypename.innerHTML= 'Booth Label  <i class="far fa-question-circle" title="Set Booth Number or other display label here."></i>';
