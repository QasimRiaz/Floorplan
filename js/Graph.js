...
mxGraph.prototype.pageBreakColor = "transparent";
...
Graph.prototype.convertValueToString = function (cell) {
  if (cell.value != null && typeof cell.value == "object") {
    if (
      ...
      return cell.value.getAttribute("mylabel");
    }
  }
  ...
  if (boothOwner != "" && boothOwner != "none" && boothOwner != "<None>") {
    jQuery.each(mxgetjosnusersData, function (key, valuee) {
      if (mxgetjosnusersData[key].exhibitorsid == boothOwner) {
        ...
        if (
          mxgetjosnusersData[key].COL != "" &&
          mxgetjosnusersData[key].COL != null
        ) {
        ...
        if (
          mxgetjosnusersData[key].COW != "" &&
          mxgetjosnusersData[key].COW != null
        ) {
        ...
        if (
          mxgetjosnusersData[key].COD != "" &&
          mxgetjosnusersData[key].COD != null
        ) {
