...
Toolbar.prototype.init = function()
{
	...
	viewMenu.style.overflow = 'hidden';
        viewMenu.style.marginTop = '2px';
        viewMenu.style.height = '20px';
        viewMenu.style.border = '1px solid #000';
        viewMenu.style.background = '#fff';
        viewMenu.style.fontSize = '13px';
        viewMenu.style.width = '42px';
